...
public class AudibleTest extends AndroidTestBase {
    ...
    public void testAudiobookTitlesAndAuthorNamesInLibraryScreen() {
        ...
        Assert.assertEquals(getLibraryScreen().getAllAudiobookTitles(), expectedBookTitles, "Audiobook titles are not matched.");
        ...
        Assert.assertEquals(getLibraryScreen().getAllAudiobookAuthors(), expectedBookAuthorNames, "Audiobook author names are not matched.");
    }
}