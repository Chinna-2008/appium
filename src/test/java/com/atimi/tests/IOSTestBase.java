...
public class IOSTestBase extends MobileTestBase<IOSDriver<IOSElement>> {
    ...
    public SignInScreenIOS getSignInScreen() {
        return getScreenRegistry().get(SignInScreenIOS.class);
    }
    ...
    public HomeScreenIOS getHomeScreen() {
        return getScreenRegistry().get(HomeScreenIOS.class);
    }
    ...
    public SearchScreenIOS getSearchScreen() {
        return getScreenRegistry().get(SearchScreenIOS.class);
    }
    ...
    public BookDetailsScreenIOS getBookDetailsScreen() {
        return getScreenRegistry().get(BookDetailsScreenIOS.class);
    }
}